...
const canEdit = (role) => role === 'ADMIN' || role === 'CHEF_KN1';
...
export default function SuiviCongesScreen({ navigation }) {
  ...
  const handleDeleteCollab = (collab) => {
    Alert.alert('Confirmation', `Supprimer ${collab.fullName} de l'année ${selectedAnnee} ?`, [
...
<table>
  ...
  <tbody>${rows}</tbody>
      ...
      await Sharing.shareAsync(uri, {
        ...
        dialogTitle: `Suivi Congés ${selectedAnnee}`,
        UTI: 'com.adobe.pdf',
      });
    } catch (e) {
